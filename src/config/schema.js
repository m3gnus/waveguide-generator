...
export const PARAM_SCHEMA = {
  ...
  FREEFORM: {
    ...
    profileH: {
      ...
      tooltip: 'Horizontal profile anchors as one axial-position/radius pair per line: z r.',
    },
    profileV: {
      type: 'points',
      ...
      tooltip: 'Vertical profile anchors as one axial-position/radius pair per line: z r.',
    },
    throatAngleH: {
      type: 'number',
      label: 'Horizontal Throat Angle',
      unit: 'deg',
      min: -90,
      max: 90,
      step: 0.1,
      default: 15.5,
      tooltip: 'Horizontal spline tangent angle at the throat.',
    },
    mouthAngleH: {
      type: 'number',
    ...
    throatAngleV: {
      type: 'number',
      label: 'Vertical Throat Angle',
      unit: 'deg',
      min: -90,
      max: 90,
      step: 0.1,
      default: 15.5,
      tooltip: 'Vertical spline tangent angle at the throat.',
    },
    mouthAngleV: {
      type: 'number',
