...
export const PARAM_SCHEMA = {
  ...
  MESH: {
    angularSegments: {
      ...
      default: 40,
      tooltip:
        'Surface sampling around the horn circumference for mesher geometry input. The live viewport uses HornLab mesher Gmsh tessellation.',
    },
    lengthSegments: {
      type: 'number',
      ...
      default: 20,
      tooltip:
        'Surface sampling along the horn length for mesher geometry input. The live viewport uses HornLab mesher Gmsh tessellation.',
    },
    cornerSegments: {
      type: 'number',
    ...
    throatSegments: {
      ...
      default: 0,
      tooltip:
        'Extra surface samples near the throat. The live viewport mesh is still generated by HornLab mesher/Gmsh.',
    },
    throatResolution: {
      type: 'number',
