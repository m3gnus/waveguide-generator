...
export const PARAM_SCHEMA = {
  ...
  FREEFORM: {
    ...
    length: {
      ...
      step: 1,
      default: 120,
      tooltip: 'Shared axial length of the horizontal and vertical profiles.',
    },
    throatRadius: {
      type: 'number',
      label: 'Throat Radius',
      ...
      step: 0.1,
      default: 12.7,
      tooltip: 'Shared throat radius for both profile planes.',
    },
    throatAngle: {
      type: 'number',
      label: 'Throat Angle',
      ...
      step: 0.1,
      default: 15.5,
      tooltip: 'Shared driver exit angle used by both profile planes.',
    },
    mouthRadiusH: {
      type: 'number',
      label: 'Horizontal Mouth Radius',
      unit: 'mm',
      step: 1,
      default: 140,
      tooltip: 'Horizontal half-width at the mouth.',
    },
    mouthAngleH: {
      type: 'number',
      label: 'Horizontal Mouth Angle',
      unit: 'deg',
      min: -90,
      max: 90,
      step: 0.1,
      default: 60,
      tooltip: 'Horizontal spline tangent angle at the mouth.',
    },
    interiorH: {
      type: 'points',
      label: 'Horizontal interior points',
      unit: 'mm',
      default: [],
      tooltip: 'Optional horizontal anchors strictly between the throat and mouth.',
    },
    throatTangentScaleH: {
      type: 'range',
      label: 'Horizontal Throat Tangent Scale',
      min: 0.1,
      max: 3,
      step: 0.1,
      default: 1,
      tooltip: 'Scales the horizontal spline tangent magnitude at the throat.',
    },
    mouthTangentScaleH: {
      type: 'range',
      label: 'Horizontal Mouth Tangent Scale',
      min: 0.1,
      max: 3,
      step: 0.1,
      default: 1,
      tooltip: 'Scales the horizontal spline tangent magnitude at the mouth.',
    },
    mouthRadiusV: {
      type: 'number',
      label: 'Vertical Mouth Radius',
      unit: 'mm',
      step: 1,
      default: 140,
      tooltip: 'Vertical half-height at the mouth.',
    },
    mouthAngleV: {
      type: 'number',
      label: 'Vertical Mouth Angle',
      unit: 'deg',
      min: -90,
      max: 90,
      step: 0.1,
      default: 60,
      tooltip: 'Vertical spline tangent angle at the mouth.',
    },
    interiorV: {
      type: 'points',
      label: 'Vertical interior points',
      unit: 'mm',
      default: [],
      tooltip: 'Optional vertical anchors strictly between the throat and mouth.',
    },
    throatTangentScaleV: {
      type: 'range',
      label: 'Vertical Throat Tangent Scale',
      min: 0.1,
      max: 3,
      step: 0.1,
      default: 1,
      tooltip: 'Scales the vertical spline tangent magnitude at the throat.',
    },
    mouthTangentScaleV: {
      type: 'range',
      label: 'Vertical Mouth Tangent Scale',
      min: 0.1,
      max: 3,
      step: 0.1,
      default: 1,
      tooltip: 'Scales the vertical spline tangent magnitude at the mouth.',
    },
    crossSections: {
      type: 'stations',
      label: 'Cross-section Stations',
      default: [
        { t: 0, shape: 'circle' },
        { t: 1, shape: 'ellipse' },
      ],
      tooltip: 'Cross-section shapes along the normalized throat-to-mouth position.',
    },
    overshootPolicy: {
      type: 'select',
      label: 'Spline Overshoot',
      options: [
