const PARAMETER_SECTION_INVENTORY = Object.freeze({
  geometry: [
    ...
    Object.freeze({
      ...
      description:
        'Primary dimensions for the selected horn family. Labels keep the canonical ATH symbol in parentheses where it helps.',
      owner: 'paramPanel',
    ...
    Object.freeze({
      ...
      description:
        'Freestanding wall-shell controls and enclosure clearances that change the exported or simulated solid.',
      owner: 'paramPanel',
      groups: Object.freeze([
        Object.freeze({
          group: 'MESH',
  ...
  simulation: [
    Object.freeze({
      ...
      description:
        'Backend BEM sweep start, end, and sample count. These stay aligned with import and export config keys.',
      owner: 'paramPanel',
      groups: Object.freeze([
        Object.freeze({
          group: 'SIMULATION',
    ...
    Object.freeze({
      ...
      description:
        'Source surface, orientation, and contour inputs used to build the radiating boundary.',
      owner: 'paramPanel',
      groups: Object.freeze([
        Object.freeze({
          group: 'SOURCE',
    ...
    Object.freeze({
      ...
      description:
        'HornLab mesher sizing and export-coordinate controls used for solves, downloads, and persisted mesh artifacts.',
      owner: 'paramPanel',
      groups: Object.freeze([
        Object.freeze({
          group: 'MESH',
