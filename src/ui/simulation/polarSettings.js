...
const POLAR_NUMERIC_FIELDS = Object.freeze([
  {
    ...
    label: 'Sweep Start',
    unit: 'deg',
    help: 'First angle sampled in each directivity plane.',
    step: 1,
  },
  {
    id: 'polar-angle-end',
    ...
    label: 'Sweep End',
    unit: 'deg',
    help: 'Last angle sampled in each directivity plane.',
    step: 1,
  },
  {
    id: 'polar-angle-step',
    ...
    label: 'Angular Step',
    unit: 'deg',
    help: 'Angle spacing between samples. Smaller values produce more samples.',
    min: 1,
    step: 1,
  },
  {
    ...
    unit: 'm',
    help: 'Distance from the chosen origin to the virtual microphone.',
    min: 0.1,
    step: 0.1,
  },
  {
    ...
    unit: 'deg',
    help: 'Reference angle used as 0 dB for directivity plots.',
    step: 1,
  },
  {
    ...
    unit: 'deg',
    help: 'Inclination of the diagonal directivity plane.',
    step: 1,
  },
]);
