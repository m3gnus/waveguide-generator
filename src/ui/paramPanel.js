...
const FORMULA_REFERENCE = {
    ...
    functions: [
        ...
        { name: 'log1p(x)', description: 'log(1 + x)' },
        ...
        { name: 'erf(x)', description: 'Error function' },
        { name: 'erfc(x)', description: 'Complementary error function' },
        { name: 'gamma(x)', description: 'Gamma function' },
        { name: 'lgamma(x)', description: 'Log-gamma function' },
        { name: 'pi()', description: 'Returns π (3.14159...)' },
