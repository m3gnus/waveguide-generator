    ...
    const options = [
      {
        ...
        tooltip:
          "Exports Frequency Response, DI, Impedance and Polar charts as PNG images rendered by the backend.",
      },
      {
        id: "2",
        ...
        tooltip:
          "Exports simulation result curves to CSV for spreadsheet or analysis workflows.",
      },
      {
        id: "3",
        ...
        tooltip:
          "Exports all available result arrays and metadata for scripting or custom post-processing.",
      },
      {
        id: "4",
        ...
        tooltip:
          "Exports a readable text summary including frequency span and response statistics.",
      },
      {
        id: "5",
        ...
        tooltip:
          "Exports directivity map data for external plotting or custom directivity analysis.",
      },
      {
        id: "6",
        label: "Impedance CSV",
        ...
        tooltip:
          "Exports impedance response (real and imaginary components) for electrical/acoustic analysis.",
      },
      {
        id: "7",
        ...
        tooltip:
          "Exports spectrum data in ABEC VACS format for ABEC-based workflows.",
      },
      {
        id: "8",
        ...
        tooltip:
          "Useful for quick visual inspection in STL viewers. For high-quality CAD surfaces, use the CSV curves with Fusion 360 import scripts.",
      },
      {
        id: "9",
        ...
        tooltip:
          "Creates *_profiles.csv and *_slices.csv (GridExport-style) for Fusion 360 CurvesImport and SurfaceImport scripts.",
      },
    ];
