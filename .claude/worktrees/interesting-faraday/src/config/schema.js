...
export const PARAM_SCHEMA = {
  ...
  MESH: {
    ...
    quadrants: {
      ...
      default: "1234",
      tooltip:
        "Legacy import-compatibility field. OCC solve/export always builds full-domain meshes (1234); partial-domain values are tolerated on import but not applied.",
      options: [
