...
test('buildWaveguidePayload omits quadrants from payload regardless of input value', () => {
  // quadrants is no longer forwarded to the OCC builder; active paths always build full-domain.
  assert.equal(
    buildWaveguidePayload(
