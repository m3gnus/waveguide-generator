...
class PolarConfig(BaseModel):
    ...
    # Optional full-sphere sampling for the 3D balloon viewer and forward
    # beam shape chart. Keep this opt-in because it adds observation points
    # and stored result data to every solve.
