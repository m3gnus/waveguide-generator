...
| HornLab Metal BEM   | `a97dc67449c6e4efee4e2e55add0d1b2ee8ded02` | `/api/solve` (Apple Silicon macOS) |
| HornLab Bempp BEM   | `96d6da9a1753f97a3da9774dd6c6ba6e8c8160a9` | `/api/solve` (cross-platform fallback) |
