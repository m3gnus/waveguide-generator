...
def test_live_routes_are_in_the_openapi_document_without_examples(tmp_path: Path) -> None:
    ...
    assert set(live_paths) == {
        ...
        f"{LIVE}/heartbeat", f"{LIVE}/deliveries", f"{LIVE}/requests",
        f"{LIVE}/requests/{{operationId}}/claim", f"{LIVE}/requests/{{operationId}}/progress",
        f"{LIVE}/requests/{{operationId}}/complete",
    }
